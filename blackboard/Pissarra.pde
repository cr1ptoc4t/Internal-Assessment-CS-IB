  ...
  Pissarra(float x, float y, float w, float h){
   ...
   pins1 = new Pin[6];
    ...
    for(int i=0; i<pins1.length; i++){
      if(i<4){
          txt = (i+1)+"";
          pins1[i] = new Pin( x + 200 , y + 50 + 80*i, 30, txt, color(blackCoral));
      } else if(i==4){
          txt = "C";
          pins1[i] = new Pin( x + 200 , y + 50 + 80*i, 30, txt, color(prussianBlue));
      } else if(i>4){
          txt = "L";
          pins1[i] = new Pin( x + 200 , y + 50 + 80*i, 30, txt, color(celadonBlue));
      }
    }
